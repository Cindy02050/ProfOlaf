...
def get_article_data(pub, pub_id, iteration: int, new_pub: bool = False, selected: SelectionStage = SelectionStage.NOT_SELECTED):
    """
...
class ArticleData:
    ...
    new_pub: bool = False
    selected: SelectionStage = SelectionStage.NOT_SELECTED
    bibtex: str = ""
    iteration: int = 0
    dict = asdict
...
class DBManager:
    SQL_TYPES = {
        ...
        float: 'REAL',
        bool: 'BOOLEAN',
        SelectionStage: 'INTEGER'  # Store enum as integer value
    }
        ...
        try:
            ...
            for field in fields(ArticleData):
                ...
                if isinstance(field_type, type) and issubclass(field_type, Enum):
                    sql_type = 'INTEGER'
                elif field_type in self.SQL_TYPES:
    ...
    def insert_iteration_data(self, data: List[ArticleData]):
        ...
        try:
            ...
            if not data:
                print("No data to insert into iterations table")
                return
